...
#ifndef SensitiveDetectorInPhantom_hh_
#define SensitiveDetectorInPhantom_hh_
...
class SensitiveDetectorInPhantom: public G4VSensitiveDetector
{
public:
	SensitiveDetectorInPhantom(G4String name);
	virtual ~SensitiveDetectorInPhantom();
